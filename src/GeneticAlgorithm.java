...
public class GeneticAlgorithm {
    ...
    private static final Comparator<Route> ROUTE_COMPARATOR =  Comparator.comparingDouble(route -> route.totalDistance);
    private static final PriorityQueue<Route> populationQueue = new PriorityQueue<>(ROUTE_COMPARATOR);
    private static final PriorityQueue<Route> nextGenerationQueue = new PriorityQueue<>(ROUTE_COMPARATOR);
